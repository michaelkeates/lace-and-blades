  ...
  query GetCloudflareAnalytics($zoneTag: String!, $start: String!, $end: String!) {
    viewer {
      zones(filter: { zoneTag: $zoneTag }) {
        # 🚀 1. RESTORED WORKING HISTORICAL VIEWS SCHEMA
        ...
        # 🚀 2. SEPARATE TRACKING NODE FOR COUNTRY DISTRIBUTION MAPS
        countryViews: httpRequests1dGroups(
          ...
          sum {
            countryMap {
              clientCountryName
              requests # Use requests since pageViews is invalid inside this map type
            }
          }
        }
      }
