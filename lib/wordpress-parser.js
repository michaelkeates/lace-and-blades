        ...
        if (
          ...
          return (
            <Box
              key={idx}
              as="blockquote"
              my={10} // Vertical spacing from other blocks
              mx={{ base: 4, md: 10 }} // Horizontal margin to pull it away from the edges
              pl={6} // Space between the purple line and the text
              py={4}
              ...
              borderRadius="md"
              // This "sx" block forces the text inside the quote to be smaller
              sx={{
                'p, span, li': {
                  fontSize: '17px !important', // Smaller than your 20px main text
                  lineHeight: '1.6',
                  mb: 4,
